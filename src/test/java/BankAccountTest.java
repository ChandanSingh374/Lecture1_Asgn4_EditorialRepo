...
void setUp() {
    ...
    @Test
    void accountNumberExists() throws Exception {
        try {
    ...
    @Test
    void roiExists() throws Exception {
        try {
    ...
    @Test
    void getSimpleInterestMethodExists() throws Exception {
        try {
    ...
    @Test
    void getSimpleInterestMethodSignatureCheck() throws Exception {
        try {
            Method getSimpleInterestMethod = bankAccount.getClass().getDeclaredMethod("getSimpleInterest", int.class);
    ...
    @Test
    void getBalanceWithInterestMethodExists() throws Exception {
        try {
    ...
    @Test
    void getBalanceWithInterestMethodSignatureCheck() throws Exception {
    ...
    @Test
    void testGetSimpleInterest() throws Exception {
        try {
            BankAccount account = new BankAccount();
    ...
    @Test
    void testGetBalanceWithInterest() throws Exception {
        try {
            BankAccount account = new BankAccount();
    ...
    @Test
    public void testGetSimpleInterestWithZeroBalance() throws Exception {
        try {
            BankAccount account = new BankAccount();
    ...
    @Test
    public void testGetBalanceWithInterestWithZeroROI() throws Exception {
        try {
            BankAccount account = new BankAccount();
            Field balanceField = BankAccount.class.getDeclaredField("balance");
            balanceField.setAccessible(true);
    ...
    @Test
    public void testGetBalanceWithInterestWithNegativeTime() throws Exception {
        try {
            BankAccount account = new BankAccount();
            Field balanceField = BankAccount.class.getDeclaredField("balance");
            balanceField.setAccessible(true);
